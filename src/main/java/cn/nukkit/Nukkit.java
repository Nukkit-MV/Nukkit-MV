...
public class Nukkit {
    ...
    public static final String NUKKIT = "Nukkit MultiVersion";
    public static final String API_VERSION = "1.0.14";
    public static final String BRANCH = "";
    public final static Properties GIT_INFO = getGitInfo();
    public final static String VERSION = "1.0.0-NMV";
    ...
    public static void main(String[] args) {
        ...
        try {
            if (TITLE) {
                System.out.print("\u001B]0;Nukkit MultiVersion\u0007");
            }
