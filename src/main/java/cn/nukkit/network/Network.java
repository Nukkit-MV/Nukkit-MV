...
public class Network {
    ...
    public DataPacket getPacket(int id) {
        ...
        if (clazz != null) {
            try {
                ...
                Server.getInstance().getLogger().error("Error while creating a class for the packet id " + id, e);
            }
        }
        return null;
    }
    ...
    private void registerPackets() {
        ...
        //TODO this.registerPacket(ProtocolInfo.CAMERA_PRESETS_PACKET, CameraPresetsPacket.class);

        // NukkitMV and PowerNukkitX only
        ...
        //TODO this.registerPacketNew(ProtocolInfo.CAMERA_INSTRUCTION_PACKET, CameraInstructionPacket.class);
