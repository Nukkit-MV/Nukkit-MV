...
public class GlobalBlockPalette {
    ...
    public static byte[] getCompiledTable(int protocol) {
        return switch (protocol) {
            ...
            case 281, 282 -> compiledTable282;
            case 291 -> compiledTable291;
            case 313 -> compiledTable313;
            case 332 -> compiledTable332;
            case 340 -> compiledTable340;
            case 354 -> compiledTable354;
            case 361 -> compiledTable361;
            case 388 -> compiledTable388;
            case 389, 390 -> compiledTable389;
            case 407, 408, 409, 410, 411 -> compiledTable407;
