...
public abstract class Entity extends Location implements Metadatable {
    ...
    public static final int DATA_COLLISION_BOX = 130;
    ...
    protected void initEntity() {
        ...
        if (!(this instanceof Player)) {
            this.entityUniqueId = this.namedTag.contains("uuid") ? UUID.fromString(this.namedTag.getString("uuid")) : UUID.randomUUID();
        }
